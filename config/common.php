...
return [
    ...
    'updates' => [
        ...
        [
            'from' => [17],
            'to' => 116,
            'titles' => ['%1 series%', '%1-series%', '% 116%', '% 118%', '% 120%', '% 125%']
        ],
        [
            'from' => [17],
            'to' => 99,
            'titles' => ['% 3 series%', '% e30%', '%e36%', '% e46%', '% 316%', '% 318%', '% 320%', '% 325%', '% 328%', '% 330%', '% 335%']
        ],
        [
            'from' => [17],
            'to' => 102,
        ...
        [
            'from' => [17],
            'to' => 102,
            'titles' => ['%5 series%', '%e39%', '% 520%', '% 525%', '% 530%', '% 545%']
        ],
        [
            'from' => [17],
            'to' => 350,
            'titles' => ['% 6 series%', '% 630%', '% 635%', '% 640%', '% 650%']
        ],
        [
            'from' => [17],
            'to' => 434,
            'titles' => ['% 7 series%', '% 730%', '% 735%', '% 750%']
        ],
        [
            'from' => [17],
            'to' => 234,
        ...
        [
            'from' => [36],
            'to' => 231,
            'titles' => ['% a class%', '% a 180%', '% a180%', '% a200%', '% a 200%']
        ],
        [
            'from' => [36],
            'to' => 313,
        ...
        [
            'from' => [36],
            'to' => 159,
            'titles' => ['% c class%', '% c 180%', '% c180%', '% c200%', '% c220%', '% c250%', '% c270%', '% c350%', '% c63%']
        ],
        [
            'from' => [36],
            'to' => 357,
        ...
        [
            'from' => [36],
            'to' => 196,
            'titles' => ['% e220%', '% e240%', '% e320%', '% e350%', '% e class%']
        ],
        [
            'from' => [36],
            'to' => 490,
            'titles' => ['% gl %', '%gl220%', '%gl320%', '%gl350%']
        ],
        [
            'from' => [36],
            'to' => 217,
        ...
        [
            'from' => [36],
            'to' => 160,
            'titles' => ['%ml250%', '%ml270%', '%ml 270%', '%ml320%', '%ml 320%', '%ml350%']
        ],
        [
            'from' => [36],
            'to' => 195,
        ...
        [
            'from' => [36],
            'to' => 198,
            'titles' => ['% s class%', '% s320%', '% s350%', '% s500%', '% s 500%']
        ],
        [
            'from' => [36],
            'to' => 133,
            'titles' => ['%280sl%', '%300sl%', '% sl280%', '% sl320%', '% sl350%']
        ],
        [
            'from' => [36],
            'to' => 178,
        ...
        [
            'from' => [52],
            'to' => 119,
            'titles' => ['%jimny%', '%jimmy%', '%sj 410%', '%sj410%']
        ],
        [
            'from' => [52],
            'to' => 171,
