                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2 text-sm">
                                    <p class="text-gray-500">This feature requires you to be logged in.</p>
                                    <ul class="mt-1">
                                        <li class="text-sm">If you have an account, click Login.</li>
                                        <li class="text-sm">If you want to create an account, click Register.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
export default {
    computed: {
        open () {
            return this.$store.state.static.modals.guest
        }
    },
    methods: {
        login () {
